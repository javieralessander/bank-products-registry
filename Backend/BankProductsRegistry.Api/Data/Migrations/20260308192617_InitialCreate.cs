        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumOpeningAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountProducts_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccountProducts_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AccountProducts_FinancialProducts_FinancialProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_AccountProducts_AccountProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountProducts_AccountNumber",
                table: "AccountProducts",
                column: "AccountNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AccountProducts_ClientId",
                table: "AccountProducts",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountProducts_EmployeeId",
                table: "AccountProducts",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountProducts_FinancialProductId",
                table: "AccountProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialProducts_ProductName_ProductType",
                table: "FinancialProducts",
                columns: new[] { "ProductName", "ProductType" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountProductId",
                table: "Transactions",
